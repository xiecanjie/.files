  ...
  spec = {
...

    {
      ...
      init = function()
        ...
        vim.keymap.set("n", "gd", "<cmd>lua require('fzf-lua').lsp_definitions     ({ winopts = { preview = { layout = 'vertical', vertical = 'up:80%' } }, jump_to_single_result = true, ignore_current_line = true, })<CR>")
        vim.keymap.set("n", "gr", "<cmd>lua require('fzf-lua').lsp_references      ({ winopts = { preview = { layout = 'vertical', vertical = 'up:80%' } }, jump_to_single_result = true, ignore_current_line = true, })<CR>")
        vim.keymap.set("n", "gi", "<cmd>lua require('fzf-lua').lsp_implementations ({ winopts = { preview = { layout = 'vertical', vertical = 'up:80%' } }, jump_to_single_result = true, ignore_current_line = true, })<CR>")
        vim.keymap.set("n", "gy", "<cmd>lua require('fzf-lua').lsp_typedefs        ({ winopts = { preview = { layout = 'vertical', vertical = 'up:80%' } }, jump_to_single_result = true, ignore_current_line = true, })<CR>")
      end,
    },
